                        ...
                        <td height="40" colspan="2" style="font-size:12px; text-indent:25px;">
                            <div style="margin: 0px auto; padding: 0px 10px; width: 680px;">
                                <div
                                    ...
                                    <p> 请及时前往<a href='http://${params.webip}:${params.webport}${params.contextpath}/#/uiTestNew/result/detail?id=${params.planLogId}' target="_blank">RabbitTest平台</a>查看您的任务执行的更多细节</p>
                                    <p>
                                </div>
                        </td>
                    </tr>

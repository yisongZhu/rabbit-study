...
insert  into `sys_job`(`job_id`,`job_name`,`job_group`,`project_id`,`method_name`,`method_params`,`cron_expression`,`misfire_policy`,`status`,`create_by`,`create_time`,`job_type`,`update_by`,`update_time`,`remark`) values (1,'ryTask','系统默认（无参）-测试客户端',0,'ryNoParams','','0/5 * * * * ?','0','1','admin','2018-03-16 11:33:00',0,'admin','2019-02-28 17:49:22',''),(2,'ryTask','系统默认（有参）',0,'ryParams','ry','0/20 * * * * ?','0','1','admin','2018-03-16 11:33:00',0,'admin','2019-02-28 09:25:44',''),(100,'ryTask','测试一下',0,'ryParams','TEST','0/30 * * * * ?','0','1','admin','2019-02-22 11:16:46',0,'admin','2019-02-28 09:04:26','测试备注1'),(121,'autoTestTask','测试一下本地客户端百度',1,'uiTest','{\"browserType\":\"Chrome_v66-67\",\"clientId\":14,\"isSendEmail\":0,\"receivers\":\"\"}','0/30 * * * * ?','0','1','admin','2019-06-10 10:27:46',1,'admin','2019-11-22 16:05:29',''),(123,'autoTestTask',' test2',1,'uiTest','{\"browserType\":\"Chrome_v66-67\",\"clientId\":7,\"isSendEmail\":0,\"receivers\":\"\"}','0/30 * * * * ?','0','1','admin','2019-06-10 10:41:47',1,'admin','2019-11-21 09:28:59','阿道夫'),(127,'autoTestNewTask','第一个新任务',1,'uiTest','{\"browserType\":\"Chrome_v66-67\",\"clientId\":18,\"isSendEmail\":1,\"receivers\":\"\"}','0/30 * * * * ?','0','1','admin','2019-11-23 19:18:47',4,'admin','2019-12-19 15:48:22','备注'),(128,'autoTestNewTask','调试任务',1,'uiTest','{\"browserType\":\"Chrome_v66-67\",\"clientId\":14,\"isSendEmail\":0,\"receivers\":\"\"}','0/30 * * * * ?','0','1','admin','2019-12-03 15:43:25',4,'admin','2019-12-13 14:07:31','');
...
) ENGINE=InnoDB AUTO_INCREMENT=154 DEFAULT CHARSET=utf8 COMMENT='定时任务调度日志表';
...
CREATE TABLE `t_api` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8mb4 COMMENT='ui自动化测试计划日志';

/*Data for the table `t_api` */

insert  into `t_api`(`id`,`name`,`labels`,`project_id`,`api_suite_id`,`method`,`env_id`,`host`,`path`,`type`,`remark`,`status`,`req_header`,`req_query`,`req_body_data`,`req_body_json`,`req_body_type`,`req_extract`,`req_assert`,`debug_rsp`,`create_by`,`create_time`,`update_by`,`update_time`) values (1,'登陆接口',NULL,1,18,'GET',NULL,'http://192.168.1.10','/test',0,'备注你坑了我',1,'[{\"key\":\"Content-Type\",\"value\":\"头信息\",\"isDel\":true},{\"key\":\"\",\"value\":\"\",\"isDel\":false}]','[{\"key\":\"query\",\"value\":\"queryValue\",\"isDel\":true},{\"key\":\"\",\"value\":\"\",\"remark\":\"\",\"isDel\":false}]','[{\"key\":\"\",\"value\":\"\",\"remark\":\"\"}]','{\n  \"type\": \"array\",\n  \"items\": {\n    \"type\": \"object\",\n    \"properties\": {}\n  }\n}','raw','[{\"content\":\"响应体\",\"extractType\":\"JSON\",\"extractExpress\":\"\",\"extractValue\":\"\"}]','[{\"content\":\"响应体\",\"extractType\":\"JSON\",\"extractExpress\":\"aaa.id\",\"extractValue\":\"\",\"expectRelation\":\"等于\",\"expectValue\":\"123\"}]',NULL,'system','2019-12-17 11:06:21','admin','2019-12-24 10:52:51'),(6,'什么接口',NULL,1,18,'GET',NULL,'http://www.baidu.com','/why',0,NULL,0,'[{\"key\":\"\",\"value\":\"\",\"isDel\":false}]','[{\"key\":\"\",\"value\":\"\",\"isDel\":false}]',NULL,NULL,'raw','[{\"content\":\"响应体\",\"extractType\":\"JSON\",\"extractExpress\":\"\",\"extractValue\":\"\"}]','[{\"content\":\"响应体\",\"extractType\":\"JSON\",\"extractExpress\":\"\",\"extractValue\":\"\"}]',NULL,'admin','2019-12-17 23:56:38','admin','2019-12-24 10:52:49'),(20,'阿萨德饭',NULL,1,18,'GET',NULL,NULL,NULL,0,NULL,0,'[{\"key\":\"\",\"value\":\"\",\"isDel\":false}]',NULL,NULL,NULL,'raw',NULL,NULL,NULL,'admin','2019-12-19 00:13:29','admin','2019-12-24 10:52:00'),(36,'大幅度',NULL,1,1,'GET',NULL,NULL,'你大爷',0,NULL,0,'[{\"key\":\"Content-Type\",\"value\":\"阿斯顿发送到\",\"isDel\":true},{\"key\":\"\",\"value\":\"\",\"isDel\":false}]','[{\"key\":\"\",\"value\":\"\",\"isDel\":false}]','[{\"key\":\"\",\"value\":\"\",\"remark\":\"\"}]','[\n  {\n    \"aaa\": 123,\n    \"bbb\": \"bbb\"\n  }\n]','raw','[{\"content\":\"响应体\",\"extractType\":\"JSON\",\"extractExpress\":\"\",\"extractValue\":\"\"}]','[{\"content\":\"响应体\",\"extractType\":\"JSON\",\"extractExpress\":\"\",\"extractValue\":\"\"}]',NULL,'admin','2019-12-21 09:00:21','admin','2019-12-24 10:52:01'),(37,'你好',NULL,1,1,'GET',NULL,NULL,'11111',0,NULL,0,'[{\"key\":\"Content-Type\",\"value\":\"aaaa\",\"isDel\":true},{\"key\":\"\",\"value\":\"\",\"isDel\":false}]','[{\"key\":\"sdfasf\",\"value\":\"asdfasd\",\"isDel\":true,\"remark\":\"你大爷的备注\"},{\"key\":\"\",\"value\":\"\",\"remark\":\"\",\"isDel\":false}]',NULL,NULL,'raw','[{\"content\":\"响应体\",\"extractType\":\"JSON\",\"extractExpress\":\"aa.bbb\",\"extractValue\":\"32141234\"},{\"content\":\"响应体\",\"extractType\":\"JSON\",\"extractExpress\":\"ccc.ad\",\"extractValue\":\"dafs\"}]','[{\"content\":\"响应体\",\"extractType\":\"JSON\",\"extractExpress\":\"aaa.bbbb1\",\"extractValue\":\"\",\"expectRelation\":\"等于\",\"expectValue\":\"22\"},{\"content\":\"响应体\",\"extractType\":\"JSON\",\"extractExpress\":\"ccc.dddd\",\"expectRelation\":\"等于\",\"expectValue\":\"555\"}]',NULL,'admin','2019-12-21 09:00:46','admin','2019-12-24 10:52:01'),(38,'自定义',NULL,1,25,'GET',NULL,NULL,'/',0,NULL,0,NULL,NULL,NULL,NULL,'raw',NULL,NULL,NULL,'admin','2019-12-22 23:08:37','admin','2019-12-24 10:52:02'),(39,'自定义1',NULL,1,25,'GET',NULL,NULL,'地方',0,NULL,0,NULL,NULL,NULL,NULL,'raw',NULL,NULL,NULL,'admin','2019-12-22 23:09:21','admin','2019-12-24 10:52:02');
...
CREATE TABLE `t_api_suite` (
  ...
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'updateTime',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COMMENT='ui自动化测试计划日志';

/*Data for the table `t_api_suite` */

insert  into `t_api_suite`(`id`,`name`,`project_id`,`remark`,`create_by`,`create_time`,`update_by`,`update_time`) values (1,'公共分类',1,NULL,'system','2019-12-17 11:05:23','system','2019-12-17 11:05:23'),(18,'自定义分类',1,NULL,'admin','2019-12-17 23:04:24','admin','2019-12-17 23:04:24'),(25,'自定义一个新的分组',1,NULL,'admin','2019-12-18 23:48:33','admin','2019-12-18 23:48:33');
...
CREATE TABLE `t_client` (
  ...
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'updateTime',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COMMENT='t_client';

/*Data for the table `t_client` */

insert  into `t_client`(`id`,`name`,`project_ids`,`client_ip`,`client_port`,`is_enable`,`status`,`java_version`,`jmeter_version`,`appium_version`,`os_name`,`remark`,`create_by`,`create_time`,`update_by`,`update_time`) values (14,'127.0.0.1:8879','1','127.0.0.1',8879,1,2,'1.8.0_161','5.1.1 r1855137','1.15.0\n','Windows 10','本地调试','','2019-11-12 10:41:05','admin','2019-12-25 13:52:52'),(18,'127.0.0.1:8999','1,2','127.0.0.1',8999,1,2,'1.8.0_161','5.1.1 r1855137','1.15.0\n','Windows 10','打包','','2019-12-13 16:29:15','admin','2019-12-24 15:21:42');
...
CREATE TABLE `t_file_info` (
  ...
  `source_type` int(2) NOT NULL DEFAULT '0' COMMENT '1、ui  2、接口',
...
insert  into `t_file_info`(`id`,`name`,`project_id`,`md5`,`content_type`,`size`,`source_id`,`source_type`,`path`,`type`,`create_by`,`create_time`,`update_by`,`update_time`) values (11,'我的一个新文件',1,'75266a5bac50ae9d528d811d0fbf087d','text/plain',813,1,1,'2019\\12\\25\\fe2eb88b45ef4832a22c5e525ae98c17-下载说明.txt',0,'admin',NULL,'admin',NULL),(13,'来来来',1,'75266a5bac50ae9d528d811d0fbf087d','text/plain',813,1,1,'2019\\12\\25\\来来来.txt',0,'admin',NULL,'admin',NULL),(14,'测试文件',1,'ff9a2dc8d68f62947c7e2d5291fe6e74','application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',11194,12,1,'2019\\12\\25\\测试文件.xlsx',0,'admin',NULL,'admin',NULL);
...
insert  into `t_global_param`(`id`,`param_name`,`project_id`,`param_type`,`param_value`,`type`,`remark`,`create_by`,`create_time`,`update_by`,`update_time`) values (1,'test',1,1,'来来来',1,'备注',NULL,'2019-06-12 16:26:25','admin',NULL),(3,'名称',1,2,'12341243',1,'备注11',NULL,'2019-09-11 16:30:34','admin',NULL),(4,'1234',1,1,'true',1,'发阿发',NULL,'2019-12-12 23:13:59','admin',NULL);
...
CREATE TABLE `t_page_element` (
  ...
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'updateTime',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COMMENT='t_client';
...
insert  into `t_plan_suite_ui`(`id`,`job_id`,`suite_id`,`sort`,`is_valid`) values (42,128,8,0,1),(51,127,8,0,1);
...
CREATE TABLE `t_project_page` (
  ...
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'updateTime',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COMMENT='t_client';
...
insert  into `t_suite_case_ui`(`id`,`suite_id`,`case_id`,`sort`,`is_valid`) values (28,8,1,0,1);
...
CREATE TABLE `t_test_case_ui_new_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=84 DEFAULT CHARSET=utf8mb4 COMMENT='ui自动化用例日志';
...
CREATE TABLE `t_test_plan_ui_new_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8mb4 COMMENT='ui自动化测试计划日志';
...
CREATE TABLE `t_test_step_ui_new_log` (
  ...
  KEY `task_case_id` (`step_id`),
  KEY `task_id` (`step_name`)
) ENGINE=InnoDB AUTO_INCREMENT=390 DEFAULT CHARSET=utf8 COMMENT='用例日志明细';
...
CREATE TABLE `t_test_suite_ui_log` (
  ...
  `create_time` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'createTime',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8mb4 COMMENT='ui自动化业务流日志';
...
insert  into `t_testcase_ui_new`(`id`,`name`,`project_id`,`timout_time`,`fail_continue`,`params`,`case_vars`,`case_type`,`remark`,`create_by`,`update_by`,`create_time`,`update_time`) values (1,'百度关键字',1,1,1,'','[{\"name\":\"百度地址\",\"value\":\"https://www.baidu.com/\",\"description\":\"\"}]',1,'',NULL,NULL,'2019-12-20 09:25:18',NULL),(9,'调试用例',1,2,0,NULL,'[]',1,NULL,'system','system','2019-12-06 18:23:35','2019-12-06 18:23:35'),(10,'公共登陆',1,2,0,'[{\"name\":\"账号\",\"description\":\"admin\"},{\"name\":\"密码\",\"description\":\"admin\"}]','[]',2,NULL,'system','system','2019-12-09 20:09:46','2019-12-09 20:09:46'),(11,'一个异常用例',1,1,0,NULL,'[]',1,NULL,'system','system','2019-12-13 14:05:49','2019-12-13 14:05:49');
